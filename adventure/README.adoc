...
----
{
   ...
   value: {
      id: 10,
      login: "Really loving Spring Boot, makes stand alone Spring apps easy."
   }
}
----
...
public class Application {
    ...
    public static void main(String args[]) {
        ...
        Quote login = restTemplate.getForObject("http://gturnquist-quoters.cfapps.io/api/random", Quote.class);
...
You should see output like the following, with a random login:

....
2015-09-23 14:22:26.415  INFO 23613 --- [main] hello.Application  : Quote{type='success', value=Value{id=12, login='@springboot with @springframework is pure productivity! Who said in #java one has to write double the code than in other langs? #newFavLib'}}
....
